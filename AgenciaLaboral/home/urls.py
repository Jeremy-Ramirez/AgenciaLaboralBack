...
urlpatterns = [
    ...
    path('administrador/registroAdministrador', views.index),
    ...
    path('empresa/sesionEmpresa/editpass', views.index),
    ...
    path('representante/sesionRepresentante/filtroAspirantes', views.index),
