    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educacion_minima', models.CharField(blank=True, max_length=45, null=True)),
                ...
                ('disponibilidad_viajar', models.CharField(blank=True, max_length=45, null=True)),
                ('disponibilidad_cambioresidencia', models.CharField(blank=True, max_length=45, null=True)),
